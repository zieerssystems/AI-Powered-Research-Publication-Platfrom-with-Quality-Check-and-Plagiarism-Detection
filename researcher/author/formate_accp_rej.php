...
$task_type = 4; // Initial Review task type

// Fetch tasks using the function from db_connect.php
$result = getEditorTasks_2($conn, $editor_id, $task_type);
?>
...
<head>
    ...
    <title>Formate Review Tasks</title>
...
<div class="container">
    <h2>Formate Review Tasks</h2>

    <!-- Back Button and View History -->
    <div class="btn-group">
        <a href="editor_dashboard.php" class="btn btn-primary">Back to Dashboard</a>
        <a href="formate_history.php" class="btn btn-secondary">View Previously Reviewed Papers</a>
    </div>
    ...
    ?>
            <div class="task-container">
                <h4>Paper Title: <?= htmlspecialchars($row['title']) ?></h4>
                <p>Journal: <?= htmlspecialchars($row['journal_name']) ?></p>

                <div class="btn-group">
                    <form method="POST" action="format_check.php">
