...
<header>
    ...
    <div class="register-dropdown" style="display: inline-block; position: relative;">
        <button class="dropbtn" style="background-color: #002147; color: white; padding: 10px 16px; border: none; border-radius: 6px; font-weight: bold; cursor: pointer;">Register ▼</button>
        <div class="dropdown-content" style="display: none; position: absolute; background-color: white; min-width: 160px; box-shadow: 0px 8px 16px rgba(0,0,0,0.2); right: 0; z-index: 1000;">
...
<div class="container">
    ...
    <h3>NOTE: The email and password you used to register with on this platform, can also be used to log in as an author after completing your author registration<a href="article_register.php?journal_id=<?php echo $journal_id; ?>&role=Author" style="color:blue; padding: 12px 16px; text-decoration:none; display:block;">Author Register</a>
           , and  submit your paper to this journal.</h3>
