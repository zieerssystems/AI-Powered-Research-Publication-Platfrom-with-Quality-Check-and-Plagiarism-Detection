...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($role === 'editor') {
        $table = "editors";
        $id_column = "editor_id";
        $upload_link = "http://localhost/my_publication_site/editor/upload_editor_contract.php?editor_id=$user_id";
    } else {
        $table = "reviewers";
        $id_column = "id";
        $upload_link = "http://localhost/my_publication_site/reviewer/upload_reviewer_contract.php?id=$user_id";
    }
