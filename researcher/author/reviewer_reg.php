...
<select id="countrySelect" class="input-box" name="country">
    ...
    <label>
    <input type="radio" name="reviewer_payment_type" value="paid" onclick="toggleBankDetails()">
    Paid Reviewer
</label>
<label>
    <input type="radio" name="reviewer_payment_type" value="unpaid" onclick="toggleBankDetails()" checked>
    Volunteer
</label>
...
<input type="file" name="cv_file" id="cv_file" class="input-box" accept=".pdf" required>
    ...
    let paymentType = document.querySelector('input[name="reviewer_payment_type"]:checked').value;
